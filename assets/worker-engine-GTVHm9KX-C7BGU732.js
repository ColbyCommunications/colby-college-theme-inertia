...
`],{type:"application/javascript"})),{type:"module"}),u=new E(l,{wasmUrl:m,logger:t,fontFallback:o}),p=URL.createObjectURL(new Blob([`async function encodeImage(imageData, imageType, quality) {
...
`],{type:"application/javascript"})),h=new y(r??2,p,t);return new _(u,{imageConverter:b(h),logger:t})}export{C as createPdfiumEngine};
