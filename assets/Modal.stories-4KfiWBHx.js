import{_ as i}from"./Modal-DSIMHxms.js";import"./iframe-BtxlOaJS.js";import"./preload-helper-PPVm8Dsz.js";const{expect:n,screen:c,waitFor:d}=__STORYBOOK_MODULE_TEST__,g={title:"Core Components/Modal",component:i,argTypes:{full:{control:"boolean",description:"Toggle full-screen mode"},focusRetain:{control:"boolean",description:"Retain/focus modal container on open"},modelValue:{control:"boolean",description:"Controls visibility (v-model)"},classes:{control:"text",description:"Custom classes for the wrapper"},slotContent:{control:"text",name:"Content Slot",description:"Text inside the modal"},slotButton:{control:"text",name:"Button Slot",description:"Text for the trigger button"}}},l=e=>({components:{Modal:i},setup(){return{args:e}},template:`
