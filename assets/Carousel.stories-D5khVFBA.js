import _ from"./Carousel-ppVqkqjz.js";import{a as r}from"./index-42ANG6Sg.js";import{a as b}from"./mock-data-iuhpH0Ld.js";import"./iframe-nsPjl7RS.js";import"./preload-helper-PPVm8Dsz.js";import"./glide.esm-YJcNIzYu.js";import"./Context-C6lbHfdn.js";import"./TextGroup-BIdUVYRQ.js";import"./index-DDlvirwQ.js";import"./noframework.waypoints-DVP5Ss7z.js";import"./ButtonGroup-BolsfJNS.js";import"./Button-OcSNVXGK.js";import"./ArrowControls-C835Y0VV.js";import"./ArrowButton-BcqmxXwT.js";import"./Picture-BimGWgGr.js";const{expect:t,spyOn:x,waitFor:c}=__STORYBOOK_MODULE_TEST__,z={title:"Core Components/Carousel",component:_},f="https://news.colby.edu/wp-json/wp/v2/posts?per_page=5&tags=561&_embed=1",N="https://news.colby.edu/wp-json/wp/v2/posts?per_page=5&categories=8,12,14,15&_embed=1",I="https://news.colby.edu/wp-json/wp/v2/external_post?story_type_slug=faculty-accomplishments&per_page=5&_embed=1",T=[{url:"https://www.colby.edu",title:"All News"}],l=[{image:{src:"https://placeholdit.com/600x400/dddddd/999999",srcset:"https://placeholdit.com/300x200/dddddd/999999 300w, https://placeholdit.com/600x400/dddddd/999999 600w",alt:"this is an alt tag",sizes:{Rectangle:"https://placehold.co/600x400",Rectangle_mobile:"https://placehold.co/300x200"}},heading:"Future of Artificial Intelligence",subheading:"Technology",paragraph:"AI is reshaping industries at an unprecedented pace.",url:"#",buttons:[{button:{size:"small",title:"button1",url:"https://www.colby.edu"}}]},{image:{src:"https://placeholdit.com/600x400/dddddd/999999",srcset:"https://placeholdit.com/300x200/dddddd/999999 300w, https://placeholdit.com/600x400/dddddd/999999 600w",alt:"this is an alt tag",sizes:{Rectangle:"https://placehold.co/600x400",Rectangle_mobile:"https://placehold.co/300x200"}},heading:"Sustainable Energy Solutions",subheading:"Environment",paragraph:"Solar and wind energy are becoming more accessible than ever.",url:"#",buttons:[{button:{size:"small",title:"button1",url:"https://www.colby.edu"}}]},{image:{src:"https://placeholdit.com/600x400/dddddd/999999",srcset:"https://placeholdit.com/300x200/dddddd/999999 300w, https://placeholdit.com/600x400/dddddd/999999 600w",alt:"this is an alt tag",sizes:{Rectangle:"https://placehold.co/600x400",Rectangle_mobile:"https://placehold.co/300x200"}},heading:"Modern Architecture Trends",subheading:"Design",paragraph:"Exploring the intersection of function and aesthetics in 2024.",url:"#",buttons:[{button:{size:"small",title:"button1",url:"https://www.colby.edu"}}]}],B=async({canvas:e,canvasElement:a,userEvent:n})=>{await c(()=>{const v=a.querySelectorAll(".carousel__main .carousel__slides-context .carousel__slides-context-wrap:first-child")[0].querySelectorAll(".text-group__heading")[0];t(v.textContent.slice(0,-1)).toBe("Future of Artificial Intelligence"),t(v).toBeVisible()});const o=a.querySelector(".carousel__main");await t(o).not.toBeNull(),await n.hover(o),await n.unhover(o);const s=e.getAllByRole("button",{name:"Next"}),A=e.getAllByRole("button",{name:"Previous"});await t(s.length).toBeGreaterThan(0),await t(A.length).toBeGreaterThan(0),await n.click(s[0]),await n.click(A[0])},i={name:"Primary",args:{render_api:!1,items:l,buttons:T},play:B},u={name:"Autoplay False",args:{render_api:!1,items:l,autoplay:!1,buttons:T},play:B},p={name:"With Heading and Paragraph",args:{render_api:!1,items:l,heading:"Latest Stories",subheading:"News",paragraph:"Stay up to date with the latest from Colby.",buttons:[{url:"https://www.colby.edu",title:"All News"}]},play:async e=>{await B(e);const{canvas:a,canvasElement:n}=e,s=n.querySelectorAll(".carousel__context")[0].querySelectorAll(".text-group__heading")[0];await t(s.textContent.slice(0,-1)).toBe("Latest Stories"),await t(s).toBeVisible()}},d={name:"Custom Interval",args:{render_api:!1,items:l,autoplay:!0,interval:300,buttons:[{url:"https://www.colby.edu",title:"All News"}]},play:B},m={name:"Single Slide (No Autoplay)",args:{render_api:!1,items:[l[0]],autoplay:!0,buttons:[{url:"https://www.colby.edu",title:"Read More"}]},play:async({canvas:e,canvasElement:a,userEvent:n})=>{await c(()=>{t(e.getByText("Future of Artificial Intelligence")).toBeInTheDocument()});const o=a.querySelector(".carousel__main");await t(o).not.toBeNull(),await n.hover(o),await n.unhover(o);const s=e.getAllByRole("button",{name:"Next"});await t(s.length).toBeGreaterThan(0),await n.click(s[0]),await t(e.getByText("Future of Artificial Intelligence")).toBeInTheDocument()}},h={name:"Light Type",args:{render_api:!0,api:"Unexpected Feed",heading:"Unexpected",paragraph:"Fallback mode check.",cta:"Read Story",autoplay:!1,buttons:[{url:"https://news.colby.edu/",title:"All News"}]},beforeEach:()=>{const e=x(r,"get").mockResolvedValue({data:b(5)});return()=>e.mockRestore()},play:async({canvas:e,userEvent:a})=>{await c(()=>{t(e.getByText("Unexpected")).toBeInTheDocument()}),await t(r.get).toHaveBeenCalledWith(f),await t(e.getByText("Innovative Research in Marine Biology")).toBeInTheDocument();const n=e.getAllByRole("button",{name:"Next"});await a.click(n[0])}},g={name:"Latest News (API Mocked)",args:{render_api:!0,api:"Latest News",heading:"News",paragraph:"Latest from Colby.",cta:"Read Story",autoplay:!1,buttons:[{url:"https://news.colby.edu/",title:"All News"}]},beforeEach:()=>{const e=x(r,"get").mockResolvedValue({data:b(5)});return()=>e.mockRestore()},play:async({canvas:e,userEvent:a})=>{await c(()=>{t(e.getByText("Innovative Research in Marine Biology")).toBeInTheDocument()}),await t(r.get).toHaveBeenCalledWith(f),await t(e.getByText("News")).toBeInTheDocument();const n=e.getAllByText("Read Story");await t(n.length).toBeGreaterThanOrEqual(1);const o=e.getAllByRole("button",{name:"Next"}),s=e.getAllByRole("button",{name:"Previous"});await a.click(o[0]),await a.click(s[0])}},y={name:"Academic News (API Mocked)",args:{render_api:!0,api:"Academic News",heading:"Academic Highlights",paragraph:"Research and scholarship from Colby faculty and students.",cta:"Read Story",autoplay:!1,buttons:[{url:"https://news.colby.edu/",title:"All Academic News"}]},beforeEach:()=>{const e=x(r,"get").mockResolvedValue({data:b(5)});return()=>e.mockRestore()},play:async({canvas:e,userEvent:a})=>{await c(()=>{t(e.getByText("Academic Highlights")).toBeInTheDocument()}),await t(r.get).toHaveBeenCalledWith(N),await t(e.getByText("Academic News")).toBeInTheDocument(),await t(e.getByText("Innovative Research in Marine Biology")).toBeInTheDocument();const n=e.getAllByRole("button",{name:"Next"}),o=e.getAllByRole("button",{name:"Previous"});await a.click(n[0]),await a.click(o[0])}},w={name:"Faculty Accomplishments (API Mocked)",args:{render_api:!0,api:"Faculty Accomplishments",heading:"Faculty News",paragraph:"Recent faculty accomplishments.",cta:"Read Story",autoplay:!1,FAbuttons:[{url:"https://news.colby.edu/external/faculty-accomplishments/",title:"All Faculty News"}]},beforeEach:()=>{const e=[{title:{rendered:"Faculty Achievement in Quantum Computing"},content:{rendered:"<p>Professor Smith published a groundbreaking paper on quantum computing that challenges existing theoretical frameworks.</p>"},external_url:"https://example.com/faculty-1"},{title:{rendered:"National Teaching Award Recipient"},content:{rendered:"<p>Professor Jones has been recognized with a national teaching award for excellence in undergraduate education.</p>"},external_url:"https://example.com/faculty-2"},{title:{rendered:"Climate Research Breakthrough"},content:{rendered:"<p>A Colby research team has made a significant discovery in understanding local climate patterns and their global implications.</p>"},external_url:"https://example.com/faculty-3"}],a=x(r,"get").mockResolvedValue({data:e});return()=>a.mockRestore()},play:async({canvas:e,userEvent:a})=>{await c(()=>{t(e.getByText("Faculty News")).toBeInTheDocument()}),await t(r.get).toHaveBeenCalledWith(I),await t(e.getByText("Faculty Achievement in Quantum Computing")).toBeInTheDocument(),await t(e.getByText("Faculty Accomplishments")).toBeInTheDocument();const n=e.getAllByRole("button",{name:"Next"}),o=e.getAllByRole("button",{name:"Previous"});await a.click(n[0]),await a.click(o[0])}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  name: "Primary",
  args: {
    render_api: false,
    items: mockItems,
