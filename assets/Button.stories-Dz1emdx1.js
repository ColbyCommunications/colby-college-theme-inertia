import{_ as i}from"./Button-D33RBgaZ.js";import"./iframe-CQJlxVxo.js";import"./preload-helper-PPVm8Dsz.js";const{expect:w}=__STORYBOOK_MODULE_TEST__,y={title:"Core Components/Button",component:i},t={name:"Primary",args:{title:"Button Title",url:"https://www.colby.edu"},play:async({canvas:e})=>{}},a={name:"Small",args:{title:"Button Title",url:"https://www.colby.edu",size:"small"},play:async({canvas:e})=>{}},r={name:"Medium",args:{title:"Button Title",url:"https://www.colby.edu",size:"medium"},play:async({canvas:e})=>{}},n={name:"Large",args:{title:"Button Title",url:"https://www.colby.edu",size:"large"},play:async({canvas:e})=>{}},s={name:"Dark",args:{title:"Button Title",url:"https://www.colby.edu",type:"dark"},play:async({canvas:e})=>{}},o={name:"With Arrow",args:{title:"Button Title",url:"https://www.colby.edu",arrow:!0},play:async({canvas:e})=>{}},l={name:"Reverse",args:{title:"Button Title",url:"https://www.colby.edu",arrow:!0,reverse:!0},play:async({canvas:e})=>{}},c={name:"Transparent Background",args:{title:"Button Title",url:"https://www.colby.edu",transparentBg:!0},play:async({canvas:e})=>{}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  name: "Primary",
  args: {
    title: "Button Title",
