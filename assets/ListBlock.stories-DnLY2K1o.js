import{_ as s}from"./ListBlock-R-3LwKv6.js";import"./iframe-D8O4XGtw.js";import"./preload-helper-PPVm8Dsz.js";import"./Context-DCn20hL-.js";import"./TextGroup-BJYOzkbT.js";import"./noframework.waypoints-DVP5Ss7z.js";import"./ButtonGroup-B-eAcsaV.js";import"./Button-stwJmPXY.js";const{expect:g}=__STORYBOOK_MODULE_TEST__,y={title:"Core Components/List Block",component:s,tags:["autodocs"],argTypes:{type:{control:"select",options:["dark","light"]}}},e={name:"Default",args:{subheading:"Bylaws",heading:"Lorem ipsum dolor sit amet, consectet lorem ipsum",paragraph:"Lorem ipsum dolor sit amet, consectetur adipi elit. Nunc lobortis ullamcorper aucto.",buttons:[{url:"https://www.colby.edu",title:"Read Bylaws"}]},play:async({canvas:r})=>{}},a={name:"Dark",args:{...e.args,type:"dark"},play:async({canvas:r})=>{}},t={name:"Light",args:{...e.args,type:"light"},play:async({canvas:r})=>{}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  name: "Default",
  args: {
    subheading: "Bylaws",
