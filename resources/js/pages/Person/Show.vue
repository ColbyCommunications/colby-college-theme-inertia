    ...
    <AppLayout>
      <section class="sidebar-page">
        <div class="sidebar-page__inner max-w-screen-2xl w-full px-5 my-0 mx-auto mt-8">
          <a class="inline-flex items-center font-body text-14 md:text-10 font-normal md:font-medium leading-140 text-indigo py-1.5 hover:text-indigo hover:underline min-h-[44px] min-w-[44px] leading-[44px]" href="/people/people-directory">
        ...
        <div class="sidebar-page__inner md:grid md:grid-cols-12 gap-x-10 max-w-screen-2xl w-full px-5 my-0 mx-auto mt-16">
          ...
          <div class="sidebar-page__main directory-person-main xl:col-start-4 md:col-span-9 space-y-16">
            <DirectoryCard 
                :name="title" 
                :pronouns="acf.pronouns" 
                :department="acf.department" 
                :title="acf.title" 
                :phone="acf.phone" 
                :curriculum_vitae="acf.curriculum_vitae" 
                :email="acf.email" 
                :location="acf.building" 
                :office_hours="acf.office_hours" 
                :address="acf.address" 
                :fax="acf.fax" 
                :bio="acf.bio" 
                :hide_pronouns="acf.hide_pronouns" 
                :hide_phone_number="acf.hide_phone_number" 
                :hide_fax="acf.hide_fax" 
                :hide_department="acf.hide_department" 
                :hide_cv="acf.hide_cv" 
                :hide_bio="acf.hide_bio" 
                :hide_office_hours="acf.hide_office_hours" 
                :hide_office_location="acf.hide_office_location" 
                :hide_photo="acf.hide_photo" 
                :hide_email="acf.hide_email" 
            ...
            <div class="grid md:grid-cols-9 w-full">
              <div class="md:col-span-6">
                <div class="wysiwyg
                  ...
                  [&_p]:font-body [&_p]:font-normal [&_p]:text-16 [&_p]:leading-[1.5] [&_p]:text-indigo
                  [&_p>a]:underline [&_p>a:hover]:no-underline [&_p>a:hover]:text-indigo
                  [&_ul+h2]:mt-20
                  [&_ul>li]:font-body [&_ul>li]:font-normal [&_ul>li]:text-16 [&_ul>li]:leading-130 [&_ul>li]:text-indigo [&_ul>li]:list-disc [&_ul>li]:list-outside [&_ul>li]:ml-3 [&_ul>li+li]:mt-2
                  [&_ul>li>a]:underline [&_ul>li>a:hover]:no-underline [&_ul>li>a:hover]:text-indigo
                  [&_ol+h2]:mt-20
                  [&_ol>li]:font-body [&_ol>li]:font-normal [&_ol>li]:text-16 [&_ol>li]:leading-130 [&_ol>li]:text-indigo [&_ol>li]:list-decimal [&_ol>li]:list-outside [&_ol>li]:ml-3 [&_ol>li+li]:mt-2
...
<script setup>
    ...
    const props = defineProps({ title: String, image: String, author: String, date: String, acf: Object, type: String, peopleMenu: {
        type: Object,
        default: () => ({
            heading: "People",
            items: [],
