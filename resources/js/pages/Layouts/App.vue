<template>
  <div>
    ...
    <main
      id="main"
      class="colby-page pb-20 md:pb-[100px] [&>div>section>div.full-bleed]:w-full [&>div>section>div:not(.full-bleed)]:px-[10px] md:[&>div>section>div:not(.full-bleed)]:mx-auto md:[&>div>section>div:not(.full-bleed)]:max-w-screen-2xl"
    >
