...
const blockRegistry = {
  ...
  "acf/featured-events": () => import("../FeaturedEvents/FeaturedEvents.vue"),
  "acf/full-bleed-hero": () => import("../FullBleedHero/FullBleedHero.vue"),
  "acf/home-section": () => import("../HomeSection/HomeSection.vue"),
  "acf/icon-section": () => import("../IconSection/IconSection.vue"),
  "acf/image-grid": () => import("../ImageGrid/ImageGrid.vue"),
  "acf/inset-widget": () => import("../InsetWidget/InsetWidget.vue"),
...
function getPlaceholderHeight(item) {
  const heights = {
    ...
    "acf/embed": 200,
    "acf/image": 200,
    "acf/endpoint-filter": 200,
    "acf/image-text": 200,
    "acf/advanced-accordion": 500,
    "acf/overlay-wide-image": 500,
    "acf/collage-section": 500,
    "acf/context-section": 500,
    "acf/featured-events": 500,
    "acf/full-bleed-hero": 250,
    "acf/home-section": 250,
    "acf/icon-section": 250,
    "acf/image-grid": 500,
    "acf/inset-widget": 250,
    "acf/list-block-grid": 250,
    "acf/media-aside": 250,
    "acf/media-context-section": 250,
    "acf/related-section": 250,
    "acf/table-section": 250,
