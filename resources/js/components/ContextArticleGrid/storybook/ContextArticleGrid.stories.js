...
export const ManualData = {
  ...
  play: async ({ canvas }) => {
    ...
    const articleHeading = await canvas.findByText(
      "Innovative Research in Biology",
    );
    await expect(articleHeading).toBeVisible();

    const articleHeading2 = await canvas.findByText(
      "New Gallery Exhibition Opens",
    );
...
export const ApiGeneral = {
  ...
  play: async ({ canvas }) => {
    ...
    const article1 = await canvas.findByText(
    ...
    const article2 = await canvas.findByText(
...
export const ApiArts = {
  ...
  play: async ({ canvas }) => {
    ...
    const article = await canvas.findByText(
      "Innovative Research in Marine Biology",
    );
