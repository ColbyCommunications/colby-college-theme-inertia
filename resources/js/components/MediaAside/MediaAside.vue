      ...
      >
        ...
        <template v-if="carousel">
          ...
          <div class="inline-flex self-end gap-4 md:pb-6">
            <button
              class="inline-flex items-center justify-center w-10 h-8 bg-indigo-100 hover:bg-cloud focus:bg-cloud rounded border border-solid border-indigo-300 transition-all duration-200 ease-in-out"
