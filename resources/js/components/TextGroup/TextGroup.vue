...
<template>
    <section class="text-group text-group--animated">
        <component
            v-if="subheading"
            :is="subheadingTag"
            class="text-group__subheading font-extended font-bold uppercase mr-4 whitespace-nowrap mb-2 md:mb-0"
            :class="[subheadingSize, 'leading-130', 'tracking-8', textAlign, subheadingColor]"
        >
            {{ subheading }}
        </component>
        ...
        <component
            v-if="heading"
            :is="headingTag"
            class="text-group__heading font-extended mt-2"
            :class="[
                headingWeight,
                headingSizeMobile,
                headingSize,
