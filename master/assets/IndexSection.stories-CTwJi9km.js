import{c as s,a as t,e as i,t as o,p as r,q as c,o as l}from"./iframe-BjMgjtiO.js";import m from"./SubpageNav-C_XSPckT.js";import d from"./Table-DFHe4S0s.js";import"./preload-helper-CNn__nYE.js";import"./index-xgxdCp6f.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./Modal-BfnWGWua.js";const p={class:"index-section"},u={class:"index-section__inner md:grid md:grid-cols-12 gap-x-10 max-w-screen-2xl w-full px-9 md:px-5 my-0 mx-auto"},_={class:"index-section__secondary md:col-span-3"},g={class:"index-section__main md:col-span-9"},f={class:"index-section__top mb-12"},y={class:"index-section__heading font-extended font-normal text-36 md:text-24 leading-100 -tracking-3 text-left text-indigo"},n={__name:"IndexSection",props:{heading:{type:String,default:""},nav:{type:Object,default:()=>({heading:"",items:[],parentPermalink:""})},table:{type:Object,default:()=>({})}},setup(e){return(x,v)=>(l(),s("div",p,[t("div",u,[t("div",_,[i(m,{heading:e.nav.heading,items:e.nav.items,"parent-permalink":e.nav.parentPermalink},null,8,["heading","items","parent-permalink"])]),t("div",g,[t("div",f,[t("h2",y,o(e.heading),1)]),i(d,r(c(e.table)),null,16)])])]))}};n.__docgenInfo=Object.assign({displayName:n.name??n.__name},{exportName:"default",displayName:"IndexSection",description:"",tags:{},props:[{name:"heading",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"nav",type:{name:"object"},defaultValue:{func:!1,value:`{
  heading: "",
  items: [],
  parentPermalink: ""
